...
slice_data = T_e[:max_r_index,::,::]/T_i[:max_r_index,::,::]
...
plt.pcolormesh(theta, rad, np.log10(slice_data.T), cmap = cmap, vmin = -3.0, vmax = 0.0)
plt.colorbar(label = r'$\log \left( T_e/T_i \right)$', fraction = 0.046, pad = -0.15)
...
f = plt.gcf()
f.savefig('harm_Te_o_Ti.png', bbox_inches = 'tight', dpi = 600)
