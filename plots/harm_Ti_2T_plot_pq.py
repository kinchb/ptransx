...
plt.colorbar(label = r'$\log T_i \left[\mathrm{keV}\right]$', fraction = 0.046, pad = -0.15)
...
f = plt.gcf()
f.savefig('harm_Ti_2T.png', bbox_inches = 'tight', dpi = 600)
