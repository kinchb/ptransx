...
plt.colorbar(label = r'$( B^2_{1000M} - B^2_{-1M} )/B^2_{-1M}$', fraction = 0.046, pad = -0.15)
...
f = plt.gcf()
f.savefig('harm_bsq_comp.png', bbox_inches = 'tight', dpi = 600)
